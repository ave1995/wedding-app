...
func (s *questionStore) CreateQuestion(ctx context.Context, text string, quizID uuid.UUID, questionType model.QuestionType, photoPath *string) (*model.Question, error) {
