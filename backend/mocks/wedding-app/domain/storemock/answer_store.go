...
// GetCorrectAnswersByQuestionID provides a mock function for the type MockAnswerStore
func (_mock *MockAnswerStore) GetCorrectAnswersByQuestionID(ctx context.Context, questionID uuid.UUID) ([]*model.Answer, error) {
	ret := _mock.Called(ctx, questionID)

	if len(ret) == 0 {
		panic("no return value specified for GetCorrectAnswersByQuestionID")
	}
...
// MockAnswerStore_GetCorrectAnswersByQuestionID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCorrectAnswersByQuestionID'
type MockAnswerStore_GetCorrectAnswersByQuestionID_Call struct {
	*mock.Call
}

// GetCorrectAnswersByQuestionID is a helper method to define mock.On call
//   - ctx context.Context
//   - questionID uuid.UUID
func (_e *MockAnswerStore_Expecter) GetCorrectAnswersByQuestionID(ctx interface{}, questionID interface{}) *MockAnswerStore_GetCorrectAnswersByQuestionID_Call {
	return &MockAnswerStore_GetCorrectAnswersByQuestionID_Call{Call: _e.mock.On("GetCorrectAnswersByQuestionID", ctx, questionID)}
}

func (_c *MockAnswerStore_GetCorrectAnswersByQuestionID_Call) Run(run func(ctx context.Context, questionID uuid.UUID)) *MockAnswerStore_GetCorrectAnswersByQuestionID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockAnswerStore_GetCorrectAnswersByQuestionID_Call) Return(answers []*model.Answer, err error) *MockAnswerStore_GetCorrectAnswersByQuestionID_Call {
	_c.Call.Return(answers, err)
	return _c
}

func (_c *MockAnswerStore_GetCorrectAnswersByQuestionID_Call) RunAndReturn(run func(ctx context.Context, questionID uuid.UUID) ([]*model.Answer, error)) *MockAnswerStore_GetCorrectAnswersByQuestionID_Call {
	_c.Call.Return(run)
	return _c
}
